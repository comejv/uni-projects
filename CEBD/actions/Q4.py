...
class Window(tk.Toplevel):
    def __init__(self, parent):
        ...
        ttk.Label(
            self,
            text="""Créer les tables manquantes, insérer les données correspondantes depuis les fichiers CSV fournis et mettre à jour l'affichage de consultation de la BD.
